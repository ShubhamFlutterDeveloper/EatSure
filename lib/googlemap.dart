...
class Home8 extends StatefulWidget{
  @override
  _Home8State createState() => _Home8State();
}
                  ...
                  child: InkWell(
                      onTap: () async {
                        ...
                        if(place != null){
                          ...
                          mapController?.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: newlatlang, zoom:13)));
                          mapController?.isMarkerInfoWindowShown(MarkerId(' '));
                        }
                      },
                      child:Padding(
